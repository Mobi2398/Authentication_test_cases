...
from application.database import User, Profile, Group
...
def group_delete(group_id):
    grouped = Group.find_by_id(group_id)
    grouped.delete()
    return redirect(url_for('authentication.groups', page='1'))
...
def group_view(group_id):
    ...
    if grouped in current_user.groups:
